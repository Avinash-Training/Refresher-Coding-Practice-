...
class Program
{
    static void Main()
    {
        ...
        {
            Id = 1, Name = "C# Basics", Course = "C#", Topic = "Syntax",
            Provider = "TechLearn",
        ...
        mgmt.AddProgram(new TrainingProgram
        {
            Id = 2, Name = "OOP Deep Dive", Course = "C#", Topic = "OOP",
        ...
        mgmt.AddProgram(new TrainingProgram
        {
            Id = 3, Name = "SQL Fundamentals", Course = "SQL", Topic = "Queries",
            Provider = "TechLearn",
        ...
        mgmt.AddProgram(new TrainingProgram
        {
            Id = 4, Name = "Advanced SQL", Course = "SQL", Topic = "Stored Procedures",
            Provider = "DataPro",
